...
<div class="wrapper">
  ...
  <div class="page-header">
    <h1>👥 Participants</h1>
    <p>Add, edit, or remove raffle entries individually</p>
  </div>
...
// ── FORM SUBMIT (add or update via AJAX) ──
...
function reNumberRows() {
  const visible = document.querySelectorAll('.entry-row');
  let n = 1;
  visible.forEach(row => {
